...
python train.py --arch resnet18 --exp-mode finetune --configs configs/configs.yml\
    --epochs 1 --save-dense --exp-name black_box_attack --black_box_eval --test-batch-size 32\
    --source-net ./trained_models/rocl_ext_adv_base/finetune/latest_exp/checkpoint/checkpoint.pth.tar