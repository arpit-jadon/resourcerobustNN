...
(   
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_adv-k_0.1-prunepochs_5"  $arch  "adv"   "adv"  "0"   0.1 5 ; #&
);

(
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_adv-k_0.05-prunepochs_5"  $arch  "adv"   "adv"  "0"   0.05  5 ; #&
);

(
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_adv-k_0.01-prunepochs_5"  $arch  "adv"   "adv"  "0"   0.01  5 ;
);

(
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_base-k_0.1-prunepochs_5"  $arch "base"   "base"  "0"   0.1  5 ; #&
);
#Natural training 
(   
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_base-k_0.05-prunepochs_5"  $arch "base"   "base"  "0"   0.05  5 ;
); 

(
    pretrain_prune_finetune_semisup  "semisup-$arch-trainer_base-k_0.01-prunepochs_5"  $arch  "base"   "base"  "0"   0.01  5 ;
);
